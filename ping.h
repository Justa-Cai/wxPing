...
typedef void (*funcPingCallBack)(BOOL bResult, CPingReply &pr);
class CPing
{
public:
//Methods
#ifdef CPING_USE_ICMP
	BOOL Ping1(const char* pHostName, CPingReply& pr, funcPingCallBack pFunc=NULL, int times=5, UCHAR nTTL = 10, DWORD dwTimeout = 5000, UCHAR nPacketSize = 32) const;
#endif
